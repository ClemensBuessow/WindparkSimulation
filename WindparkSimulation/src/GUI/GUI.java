...
public class GUI {
    ...
    public GUI(Scene scene, Pane pane) {
        ...
        pane.getChildren().addAll(gamefield, settings, windpark, windrichtung, windstaerke, voegel, boeen,
                brand, gesamtKW, start, stop, reset, add, delete, x1, x2, x4, bottomLine, sideline,
                settingLine, vogelYes, vogelNo, brandYes, brandNo, boeenYes, boeenNo, windRichtung, windGrad);
        scene.setRoot(pane);
